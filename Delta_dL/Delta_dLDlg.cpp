...
BEGIN_EASYSIZE_MAP(CDelta_dLDlg)
	...
	EASYSIZE(IDC_CONNECT_STATE,ES_KEEPSIZE,ES_BORDER,ES_BORDER,ES_KEEPSIZE,0)
	EASYSIZE(IDC_EDIT2,ES_KEEPSIZE,ES_BORDER,ES_BORDER,ES_KEEPSIZE,0)
	EASYSIZE(IDC_DELTL,ES_KEEPSIZE,ES_BORDER,ES_BORDER,ES_KEEPSIZE,0)
	EASYSIZE(IDC_LOSS,ES_KEEPSIZE,ES_BORDER,ES_BORDER,ES_KEEPSIZE,0)
	EASYSIZE(IDC_FSR,ES_KEEPSIZE,ES_BORDER,ES_BORDER,ES_KEEPSIZE,0)
